...
auto main(int argc, char* argv[]) -> int {
    ...
    if (err) {
        ...
        std::cout << "AnkiXourj started with PID: " << g_subprocess_get_identifier(p.get()) << std::endl;
        errorlog << "AnkiXourj started with PID: " << g_subprocess_get_identifier(p.get()) << std::endl;
